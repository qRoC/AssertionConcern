...
URL_PATH_REGEX="/builds/development/${URL_PATH_DATA1}/swift-DEVELOPMENT-SNAPSHOT-[0-9]{4}-[0-9]{2}-[0-9]{2}-a/swift-DEVELOPMENT-SNAPSHOT-[0-9]{4}-[0-9]{2}-[0-9]{2}-a-${URL_PATH_DATA2}"
