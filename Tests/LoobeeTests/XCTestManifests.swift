...
extension AssertionConcernTests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__AssertionConcernTests = [
        ("testSatisfyErrorContent", testSatisfyErrorContent),
        ("testSatisfyErrorType", testSatisfyErrorType),
        ("testSatisfyWithNilArguments", testSatisfyWithNilArguments),
        ("testSatisfyWithoutNotifications", testSatisfyWithoutNotifications),
    ]
}
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        ...
        testCase(AssertionConcernTests.__allTests__AssertionConcernTests),
